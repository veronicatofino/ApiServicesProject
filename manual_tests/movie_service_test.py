...
# vagrant
conn = http.client.HTTPConnection("192.168.56.120:5000")
...
headers = {
    ...
    'authorization': 'Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJibHVlIiwiaWRlbnRpdHkiOiJibHVlIiwiYXV0aG9yaXRpZXMiOlsiUk9MRV9VU0VSIl0sImlhdCI6MTYwMzA3NDAyOCwiZXhwIjoxNjAzMDc0NjI4fQ.rGWABdhkoNoapZfX8UtM8m3tb99Yy31JiAr3DNnAIDF7v6DBOD-p5DBhUrZ1WWUDJln0ZL81u1CWG025PBvshw'
}
